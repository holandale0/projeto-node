...
/****** Object:  StoredProcedure [dbo].[pr_CA_NOTIF_s_NotificacaoFleury]    Script Date: 02/07/2018 16:27:29 ******/
SET ANSI_NULLS ON
GO
...
NOME DO OBJETO.: pr_CA_NOTIF_s_NotificacaoFleury
SISTEMA/PROJETO: Agendamento - Integração WISE
DESCRIÇÃO .....: Busca por notificação com base nos parâmetros.
AUTOR..........: Leonardo Holanda Araujo - Opah IT Consulting
DATA...........: 25/05/2018
MOTIVO.........: Retornar notificação com base nos parâmetros.
Resultado(s)...: Retornar notificação com base nos parâmetros.
Objetivo(s)....: Retornar notificação com base nos parâmetros.
Versão.........: 1.0
------------------------------------------------------------------------------------------------------------------
...
TESTE 1:
[dbo].[pr_CA_NOTIF_s_NotificacaoFleury]
	@TIPO = CONVENIO
...
CREATE PROCEDURE [dbo].[pr_CA_NOTIF_s_NotificacaoFleury]
(
@TIPO AS VARCHAR(30),
@INICIO AS DATETIME
)
...
ELSE IF @TIPO = 'EMPRESA' 
    ...
    BEGIN -- [02] Início
        ...
        null as code, 
        'EMPRESA' as tipo,
        null as instante --EMCV.EMVC_DH_ATUALIZACAO as instante
		...
		FROM CV_CDTB_EMPRCONVENIO_EMCV EMCV WITH(NOLOCK)
		--WHERE (EMCV.EMCV_DH_CADASTRO >= @INICIO)
...
ELSE IF @TIPO = 'PLANO' 
    ...
    BEGIN -- [02] Início
        ...
        null as code, 
        'PLANO' as tipo, 
        null as instante --PLSA.PLSA_DH_ATUALIZACAO as instante
